...
shooter='gunman|killer|shooter' #otherwise shooters,gunmen,killers
...
namePatternString= "(shooter|murderer|killer|gunman[\s,]+)([a-zA-Z]+\s[a-zA-Z]+)" # age at the end : ([,\s\d]*
...
foundPatternString= "(killer|shooter|gunman|"+killerName+")[\sa-z]{1,10}found([a-z\s]+)"

planPatternString= "(shooter[\'s]*|killer[\'s]*|gunman[\'s]*|"+killerName+"[\'s]*)([a-z\s]{1,25} plan[a-z\s\"]+)"
...
targetPatternString= "([a-z\s,]+shooter[a-z\s]*|[a-z\s,]+killer[a-z\s]*|[a-z\s,]+gunman[a-z\s]*|[a-z\s,]+"+killerName+"[a-z\s]*)(targeted[a-z\s\"]+|(shot|fire)[a-z\s\"]*random[a-z\s\"]*)"
