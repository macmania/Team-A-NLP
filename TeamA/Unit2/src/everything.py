...
files = glob.glob("../../lib/Corpus/Texas Fertilizer Plant Explosion/*.txt")
    ...
    try: 
        with open(name) as f: 
            ...
            if classifyTxt(lines):
                ...
                newFile = open(str("../output/TexasExtractedFiles/" + fileName), 'w')
...
def writeStopWords(stopWordSet):
    stopWordFile=open('../output/SubLang_StopWords.txt','w')
...
listOfTexts = []
directory = "../output/TexasExtractedFiles/*.txt"
